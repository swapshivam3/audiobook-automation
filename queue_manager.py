...
q_sanitize = Queue("sanitize", connection=redis_client)
q_noise = Queue("noisereduction", connection=redis_client)
q_download = Queue("download", connection=redis_client)
